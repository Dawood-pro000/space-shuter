        ...
        <?php foreach ($destinations as $post): ?>
            <div class="bg-surface border border-white/5 rounded-xl overflow-hidden group hover:border-white/10 transition-all shadow-2xl relative">
                ...
                <div class="h-[300px] overflow-hidden relative">
                    <img src="<?= htmlspecialchars($post['image_url']) ?>" alt="Destination" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[15s]">
                ...
                <div class="p-8">
                    <div class="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-white/10">
                        ...
                        <div>
                            <div class="text-[10px] text-gray-500 uppercase tracking-widest mb-1">Distance</div>
                            <div class="text-sm text-gray-200">Far Away</div>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="/space-shuter/article/<?= htmlspecialchars($post['slug']) ?>" class="bg-brand-purple/20 border border-brand-purple text-white text-xs uppercase tracking-wider px-6 py-2.5 rounded font-semibold transition-all hover:bg-brand-purple shadow-[0_0_10px_rgba(126,34,206,0.2)]">Learn More</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
