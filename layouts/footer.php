    ...
    <footer class="bg-black border-t border-white/10 py-16 px-8 mt-20 relative z-10">
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-12">
            <div class="space-y-4">
                ...
                <p class="text-xs text-gray-600 font-light mt-2 max-w-xs">A hyper-luxury digital experience designed for the elite few who dare to explore the cosmos.</p>
            </div>
            <div class="flex gap-16">
                <div class="space-y-4">
                    <h4 class="text-sm font-semibold text-white uppercase tracking-widest">Experiences</h4>
                    <div class="flex flex-col gap-3 text-sm text-gray-400 font-light">
                        <a href="/space-shuter/discover" class="hover:text-brand-gold transition-colors">Observatory</a>
                        <a href="/space-shuter/planet" class="hover:text-brand-gold transition-colors">Residences</a>
                        <a href="/space-shuter/study-planner" class="hover:text-brand-gold transition-colors">Genesis</a>
                    </div>
                </div>
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col gap-3 text-sm text-gray-400 font-light">
                        ...
                        <a href="/space-shuter/contact" class="hover:text-brand-gold transition-colors">Concierge</a>
